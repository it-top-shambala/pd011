...
-- 16. Таблица покупка.
INSERT INTO table_buing (buy_date, company_name, id_user, id_buy_status)
VALUES
('12.02.2020','Компания 1','1','1'),
('16.08.2021','Компания 2','2','2'),
('29.11.2019','Компания 3','3','1');

-- 17. Продажа со скидкой по публикации книги.
...
-- 18. Продажа по публикации книги.
INSERT INTO table_buy_publication_of_book (id_buy, id_publication_of_book, quntity)
VALUES
('1','3','12'),
('2','4','10'),
('3','5','6');
